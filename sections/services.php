...
function std_customize_register_services( $wp_customize ) {

	// Section

	$section_id = 'std_section_services';
	$slug = 'std_section_services_';

  $wp_customize->add_section(
      $section_id,
      array(
          'title'         => __('Services (Type A)', 'std'),
          'priority'      => 100,
...
add_action( 'customize_register', 'std_customize_register_services' );
